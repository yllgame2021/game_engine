...
public class MyAppLication extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        //将参数修改为自己申请的参数，application, appid, googleClientId, appsFlyersDevKey,bugly ID
        YllGameSdk.getInstance().init(this, "appid", "googleClientId", "appsFlyersDevKey", "bugly ID");
